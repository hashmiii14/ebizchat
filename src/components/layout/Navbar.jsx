        ...
        <div className="flex items-center justify-between h-20">
                  ...
                  >
                    <Link
                      ...
                      className={`px-3.5 lg:px-4 py-2 rounded-xl text-[14px] lg:text-[15px] font-semibold tracking-[-0.01em] transition-all flex items-center gap-1.5 focus:outline-none ${
                        isActive || isOpen
                          ? 'text-[#ff5500] bg-orange-50/80 font-bold'
                          : 'text-slate-800 hover:text-[#ff5500] hover:bg-zinc-50'
                      }`}
                    ...
                    >
                      ...
                      <ChevronDown
                        className={`w-3.5 h-3.5 transition-transform duration-200 ${
                          isOpen ? 'rotate-180 text-[#ff5500]' : 'text-slate-400 group-hover:text-slate-700'
                        }`}
                      />
                    </Link>
                                  ...
                                  <div className="flex-1 min-w-0">
                                    <div
                                      className={`text-xs font-bold transition-colors flex items-center justify-between ${
                                        isItemActive
                                          ? 'text-[#ff5500]'
                                          : 'text-slate-900 group-hover:text-[#ff5500]'
                                      }`}
                                    >
                                      <span className="truncate">{item.title}</span>
                                      <ArrowRight className="w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity text-[#ff5500] flex-shrink-0" />
                                    </div>
          ...
          <div className="hidden md:flex items-center gap-2">
            <button
              ...
              className="px-3.5 py-2 rounded-xl text-[13px] font-semibold text-slate-700 hover:text-slate-900 hover:bg-zinc-100 transition-colors"
            >
              Book Demo
            </button>
            <button
              onClick={onOpenContactModal}
              className="px-4 py-2 rounded-xl text-[13px] font-bold text-white bg-[#ff5500] hover:bg-[#e04a00] shadow-sm shadow-[#ff5500]/25 transition-all active:scale-95 inline-flex items-center gap-1.5"
            >
          ...
          <div className="p-4 space-y-1">
                    ...
                    <div className="flex items-center justify-between">
                      <Link
                        ...
                        className={`py-2 px-2 text-base font-bold transition-colors ${
                          isActive ? 'text-[#ff5500]' : 'text-slate-900 hover:text-[#ff5500]'
                        }`}
                      >
                        {link.name}
                      </Link>
                          ...
                          return (
                            <Link
                              ...
                              className={`flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm transition-colors ${
                                isSubActive
                                  ? 'bg-orange-50 text-[#ff5500] font-semibold'
                                  : 'text-slate-700 hover:text-[#ff5500] hover:bg-zinc-50'
                              }`}
                            >
                              <IconComponent className="w-4 h-4 text-[#ff5500]" />
                              <span>{sub.title}</span>
                            </Link>
                          );
                        })}
            ...
            <div className="pt-4 mt-3 border-t border-slate-100 grid grid-cols-2 gap-2.5">
              <button
                ...
                className="w-full py-2.5 px-3 rounded-xl bg-zinc-100 hover:bg-zinc-200 text-slate-900 font-semibold text-xs transition-colors text-center"
              >
                Book Demo
              </button>
              <button
                ...
                className="w-full py-2.5 px-3 rounded-xl bg-[#ff5500] hover:bg-[#e04a00] text-white font-bold text-xs shadow-sm shadow-[#ff5500]/25 transition-colors text-center"
              >
                Get Started
              </button>
            </div>
