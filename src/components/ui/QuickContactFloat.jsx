...
export default function QuickContactFloat() {
  ...
  return (
    <>
      {/* ─── LEFT SIDE FLOATING BUTTON = CALL (BOTTOM LEFT) ─── */}
      <div className="fixed bottom-6 left-4 sm:left-6 z-50 pointer-events-auto">
        <a
          href={`tel:${callNumber}`}
          className="relative group w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-emerald-600 hover:bg-emerald-700 text-white flex items-center justify-center shadow-2xl shadow-emerald-600/40 transition-all hover:scale-110 active:scale-95 focus:outline-none ring-2 ring-white/80"
        ...
        >
          ...
          <div className="absolute bottom-full mb-2.5 left-0 px-3 py-1.5 rounded-lg bg-slate-900 text-white text-xs font-semibold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-all duration-200 pointer-events-none shadow-xl border border-slate-700 flex items-center gap-1.5">
      ...
      {/* ─── RIGHT SIDE FLOATING BUTTON = WHATSAPP (BOTTOM RIGHT) ─── */}
      <div className="fixed bottom-6 right-4 sm:right-6 z-50 pointer-events-auto">
        <a
          href={whatsappUrl}
          target="_blank"
          rel="noopener noreferrer"
          className="relative group w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-white flex items-center justify-center shadow-2xl shadow-emerald-500/40 transition-all hover:scale-110 active:scale-95 focus:outline-none ring-2 ring-white/80"
        ...
        >
          ...
          {/* Tooltip on hover (appears above/left) */}
          <div className="absolute bottom-full mb-2.5 right-0 px-3 py-1.5 rounded-lg bg-slate-900 text-white text-xs font-semibold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-all duration-200 pointer-events-none shadow-xl border border-slate-700 flex items-center gap-1.5">
