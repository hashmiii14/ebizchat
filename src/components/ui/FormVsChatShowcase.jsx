    ...
    <section className="py-20 lg:py-28 bg-white border-b border-slate-100 overflow-hidden select-none">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14 space-y-3">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-orange-50 border border-orange-200/80 text-[#ff5500] text-xs font-semibold font-mono tracking-wide">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-950 tracking-tight leading-[1.12]">
            ...
            <span className="text-[#ff5500]">Conversations convert 3.8x better.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch max-w-5xl mx-auto">
          ...
          <div className="lg:col-span-6 rounded-2xl border-2 border-[#ff5500] bg-orange-50/20 p-6 flex flex-col justify-between relative shadow-lg shadow-[#ff5500]/10">
            {/* Top Status */}
            <div>
              <div className="flex items-center justify-between pb-3 border-b border-orange-200/80 mb-4">
                ...
                <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono bg-[#ff5500] text-white font-bold">
                  24.6% Avg Conversion
                </span>
              </div>

              {/* Chat Experience Mockup */}
              <div className="space-y-2.5 bg-white p-4 rounded-xl border border-orange-200/80 shadow-xs text-xs">
                {/* Incoming Prompt */}
                <div className="flex justify-start">
                  <div className="max-w-[88%] bg-zinc-100 text-slate-800 rounded-xl rounded-tl-xs p-2.5 space-y-1">
                ...
                <div className="flex flex-wrap gap-1.5 pl-2">
                  <span className="px-2.5 py-1 rounded-lg bg-orange-50 text-orange-950 font-semibold border border-orange-200 text-[10px]">
                    📦 50 – 200 Units
                  </span>
                  <span className="px-2.5 py-1 rounded-lg bg-[#ff5500] text-white font-bold text-[10px] shadow-xs">
                ...
                <div className="flex justify-start">
                  <div className="max-w-[92%] bg-orange-50/70 border border-orange-200 text-zinc-950 rounded-xl rounded-tl-xs p-2.5 space-y-1.5">
                    <div className="flex items-center justify-between font-bold text-[10px] text-[#ff5500]">
            ...
            {/* Wins */}
            <div className="mt-6 pt-4 border-t border-orange-200/80 space-y-1.5 text-xs text-slate-700">
              <div className="flex items-center gap-2 text-zinc-950 text-[11px] font-semibold">
        ...
        <div className="mt-12 text-center">
          <button
            ...
            className="px-8 py-4 rounded-xl text-sm font-bold text-white bg-[#ff5500] hover:bg-[#e04a00] shadow-md shadow-[#ff5500]/25 transition-all active:scale-[0.98] inline-flex items-center gap-2 cursor-pointer"
          >
