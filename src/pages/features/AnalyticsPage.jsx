...
import { CampaignAnalyticsMockup } from '../../components/ui/DashboardMockups';

export default function AnalyticsPage({ onOpenDemoModal, onOpenContactModal }) {
  const feat = FEATURES_DATA.analytics;
    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <section className="pt-12 pb-20 lg:pt-16 lg:pb-24 bg-gradient-to-b from-slate-50 via-white to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-50 border border-rose-200 text-rose-700 text-xs font-mono font-semibold">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-6 border-t border-slate-100 max-w-2xl mx-auto">
              {feat.stats.map((s) => (
                <div key={s.label}>
                  <div className="font-mono font-bold text-2xl text-rose-600">{s.value}</div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            ...
            title="Insights That Impact Your Bottom Line"
            subtitle="Understand customer demand trends, optimize sales rep training, and track exact revenue attribution."
          />
      ...
      <section className="py-20 bg-slate-900 text-white text-center">
        <div className="max-w-4xl mx-auto px-4 space-y-6">
          <h2 className="text-3xl font-bold">Transform Conversations into Measurable Revenue</h2>
          <p className="text-slate-300 text-sm max-w-lg mx-auto">
            Unlock real-time MIS reporting and agent accountability across your entire communication infrastructure.
          </p>
          <div className="pt-2">
            <button
              onClick={onOpenContactModal}
