...
import { WorkflowAutomationMockup } from '../../components/ui/DashboardMockups';

export default function AutomationPage({ onOpenDemoModal, onOpenContactModal }) {
  const feat = FEATURES_DATA.automation;
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Breadcrumbs
            items={[
              ...
              { label: 'Workflow & Business Automation' },
            ]}
          />
        </div>
      </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            badge="Trigger-Condition-Action"
            title="Automate Every Repetitive Touchpoint"
            subtitle="Free your staff from drafting the same dispatch messages, payment follow-ups, and quotation check-ins."
          />
      ...
      <section className="py-20 bg-slate-900 text-white text-center">
        <div className="max-w-4xl mx-auto px-4 space-y-6">
          <h2 className="text-3xl font-bold">Put Your Business Follow-Ups on Autopilot</h2>
          <p className="text-slate-300 text-sm max-w-lg mx-auto">
            Design your first automated workflow in under 15 minutes with Orizer eBizChat's visual canvas.
          </p>
          <div className="pt-2">
            <button
              onClick={onOpenContactModal}
