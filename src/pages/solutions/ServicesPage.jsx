...
export default function ServicesPage({ onOpenDemoModal, onOpenContactModal }) {
  const sol = SOLUTIONS_DATA.services;
    ...
    <div className="flex flex-col min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-6 border-t border-slate-100 max-w-2xl mx-auto">
              {sol.results.map((r) => (
                <div key={r.label}>
                  <div className="font-mono font-bold text-2xl text-teal-600">{r.metric}</div>
      ...
      <section className="py-20 bg-slate-50/70 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            ...
            title="Accelerate Engagements & Milestone Delivery"
            subtitle="Coordinate KYC documents, sprint approvals, and meeting invites over WhatsApp."
          />
      ...
      <section className="py-20 bg-slate-900 text-white text-center">
        <div className="max-w-4xl mx-auto px-4 space-y-6">
          <h2 className="text-3xl font-bold">Deliver a White-Glove Experience to Every Client</h2>
          <p className="text-slate-300 text-sm max-w-lg mx-auto">
            Cut back-and-forth emails and run frictionless client operations on eBizChat.
          </p>
          <div className="pt-2">
            <button
              onClick={onOpenContactModal}
